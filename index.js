...
const finalizeAgent = sbit.contract("FinalizeAgent")
...
async function showinfo() {
  ...
  console.log("minimum funding goal:", await crowdsale.returnCurrency("sbit", "minimumFundingGoal"))
 ...
 * @param amount {number} amount to invest (in sbit)
 */
...
async function investedBy(address) {
  const amount = await crowdsale.returnCurrency("sbit", "investedAmountOf", [address])
  console.log("invested by:", address)
  console.log("amount (sbit):", amount)
